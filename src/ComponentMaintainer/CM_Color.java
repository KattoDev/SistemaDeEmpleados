...
public class CM_Color {
    ...
    /**
     * @return the color for the hero background
     * EGGSHELL
     */
    ...
    /**
     * @return the color for the buttons
     * DESERT_SAND
     */
    ...
    /**
     * @return the color used for the close button in the layout
     * COPPER_RED
     */
    ...
    /**
     * @return the color used when the user hovers the mouse on the close button
     * CHESTNUT
     */
