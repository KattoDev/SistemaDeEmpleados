...
public class DatabaseConection {
  ...
  private final String urlRoot = "localhost";
  private final String urlPort = "3306";
  private final String dbUser = "DatabaseConnection";
  private final String dbPassword = "fMBTBgjNRZyyiv3C";
  private final String dbRoot = "employeesystem";
      ...
      try {
        connection =
            DriverManager.getConnection(
                "jdbc:mysql://" + urlRoot + ":" + urlPort + "/" + dbRoot, dbUser, dbPassword);
