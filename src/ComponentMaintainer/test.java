...
public class test {
    ...
    public static void main(String[] args) {
        ...
        "NAME: " + dbc.resultSet.getString("name") + "\n" +
        "ADDRESS: " + dbc.resultSet.getString("address") + "\n" +
        "BIRTHDAY: " + dbc.resultSet.getString("birthday") + "\n" +
        "PHONE NUMBER: " + dbc.resultSet.getString("phoneNumber") + "\n" +
        "EMAIL: " + dbc.resultSet.getString("email") + "\n" +
        "POSITION: " + dbc.resultSet.getString("position") + "\n" +
        "SALARY: " + dbc.resultSet.getString("salary") + "\n" +
        "USER PASSWORD: " + dbc.resultSet.getString("password") + "\n" +
        "IS ADMIN: " + dbc.resultSet.getString("isAdmin") + "\n"
        );
        }
        dbc.CloseConnection();
        }catch(
