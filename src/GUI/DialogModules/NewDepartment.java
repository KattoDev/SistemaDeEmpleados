...
public class NewDepartment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(CM_Color.Button());
        ...
        jTextField2.setBackground(CM_Color.Button());
        jTextField2.setText("Encargado:");
        ...
        jTextField3.setBackground(CM_Color.Button());
        jTextField3.setText("Nombre del encargado:");
    ...
    private void btn_lbl_cancelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_lbl_cancelMouseClicked
        int userOption = JOptionPane.showConfirmDialog(this, "¿Desea descartar la creación de un nuevo departamento?", "", JOptionPane.INFORMATION_MESSAGE);
