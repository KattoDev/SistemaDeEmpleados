...
public class Login extends javax.swing.JFrame {
    ...
    private void txt_passwordFocusGained(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_txt_passwordFocusGained
        // TODO Fix this because txt_password don't work with getText()
    ...
    private void loginContainerMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_loginContainerMouseClicked
        ...
        // ! TODO Arreglar la deprecación de getText() -> getPassword()
        String password = txt_password.getText();

        dbc.connectDatabase();
        System.out.println("select * from users where email = \"" + username + "\"");

        try {
                dbc.resultSet = dbc.statement.executeQuery("select * from users where email = \"" + username + "\"");

            if (dbc.resultSet.next()) {

                String id = dbc.resultSet.getString("id");
                String user = dbc.resultSet.getString("email");
                String psw = dbc.resultSet.getString("password");
